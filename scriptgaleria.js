    ...
    function init() {
        ...
        // --- CÓDIGO CLAVE CORREGIDO PARA CARGAR EL MODELO ---
        // La ruta debe ser absoluta para funcionar en GitHub Pages.
        // Reemplaza 'nombre-de-tu-usuario' y 'nombre-de-tu-repositorio' con los tuyos.
        const repoName = 'iglesia'; // Reemplaza con el nombre de tu repositorio
        const modelPath = `https://fr3d5.github.io/${repoName}/modelos/padresito.glb`;
    ...
    function animate() {
        ...
        controls.update(); // Corregido: esta línea es crucial para que los controles funcionen
